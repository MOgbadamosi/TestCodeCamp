...
public class SeleniunWebSignupTest {
    ...
    public void positiveSignup() throws InterruptedException {
        ...
        driver.findElement(By.id("user_username")).sendKeys("gmaayrreeeew1");
        driver.findElement(By.id("user_email")).sendKeys("gmaayreew4@mailinator.com");
        driver.findElement(By.id("user_password")).sendKeys("gmaareereew@3");
